...
class connect_tool():
    ...
    def __init__(self):
        ...
        pm.button('ConnectFromListAdd_btn', w=65, l='ADD', c= pm.Callback(self.connectFromListAdd))
        pm.button('ConnectFromListRemove_btn', w=65, l='REMOVE', c= pm.Callback(self.connectFromListRemove))
        pm.button('ConnectFromListClear_btn', w=65, l='CLEAR', c= pm.Callback(self.connectFromListClear))
        ...
        pm.button('ConnectToListAdd_btn', w=65, l='ADD', c= pm.Callback(self.connectToListAdd))
        pm.button('ConnectToListRemove_btn', w=65, l='REMOVE', c= pm.Callback(self.connectToListRemove))
        pm.button('ConnectToListClear_btn', w=65, l='CLEAR', c= pm.Callback(self.connectToListClear))
    ...
    def connectFromListClear(self):
        selItemList = pm.textScrollList('ConnectFromList', q=True, allItems=True)
        if selItemList:
            for item in selItemList:
                pm.textScrollList('ConnectFromList', e=True, removeAll=True)
    ...
    def connectToListClear(self):
        selItemList = pm.textScrollList('ConnectToList', q=True, allItems=True)
        if selItemList:
            for item in selItemList:
                pm.textScrollList('ConnectToList', e=True, removeAll=True)
